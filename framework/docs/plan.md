...
Niches keyed by objective-supplied behavior descriptors (coding objective: `(surface_edited, pass_band, mean_steps_band)`); elitist replacement, ties → lower cost; frontier-biased + ε-underfilled parent sampling [1504.04909]; ancestor pointers → re-seed on 2-generation regression [2505.22954]; persisted `archive.json`.
